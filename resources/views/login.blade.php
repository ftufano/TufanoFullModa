                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <a href="">
                                                <img src="img/tufanofullmoda_login_logo.png" class="cm-img-h-w">
                                            </a>
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a class="small cm-a-clr" href="{{url('forgot-password')}}">@lang('Forgot Your Password?')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="sticky-footer">
                ...
                <div class="copyright text-center text-light my-auto">
                    <span>@lang('All rights reserved.') &copy; @lang('webtags.company_name') 2023 | 
                        @lang('Web Site Developed By:') <b><a href="https://caelumdev.com" class="cm-a-clr" target="_blank"> @lang('webtags.caelumdev')</a></b></span>
                </div>
                </div>
            </footer>
