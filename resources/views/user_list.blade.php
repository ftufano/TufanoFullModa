...
@section('user_list_title')
    @lang('webtags.company_name') | @lang('Users Management')
@endsection

@section('user_list_header')
              ...
              @if (count($users) > 0)   
                @foreach($users as $user) 
                  <tr>
                    ...
                    <td id="userType">{{ $user->user_type }}</td>
                    <td>
        ...
        <div class="modal-body">
          <form method="POST" id="creUserForm" action="{{ route('createUser') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control form-control-user" id="inputUserType" name="user_type">
                    <option>@lang('Administrator')</option>
                    <option>@lang('Seller')</option>
        ...
        <div class="modal-body">
          <form method="POST" id="updUserForm" action="{{ route('updateUser') }}">
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-user" id="inputEditUserType" name="user_type">
                  <option value="@lang('Administrator')">@lang('Administrator')</option>
                  <option value="@lang('Seller')">@lang('Seller')</option>
